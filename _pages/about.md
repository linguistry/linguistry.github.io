...
+ **Won**, Y.(in press). Assessing the efficacy of word error rate as a proxy for pronunciation quality: A comparative study of ASR systems and human evaluations among young EFL learners. *Journal of Second Language Pronunciation*. [(SCOPUS, ESCI)]([https://doi.org/](https://doi.org/10.1075/jslp.25012.won) [(Supplementary Materials)](https://github.com/linguistry/WER_proxy_for_pronunciation_quality)
